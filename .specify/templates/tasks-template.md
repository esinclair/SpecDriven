...
> Write tests early. Ensure new tests fail before implementation when practical.

- [ ] T010 [P] \[US1\] Contract test(s): endpoint request/response matches OpenAPI
...
- [ ] T020 [P] \[US2\] Contract test(s): endpoint request/response matches OpenAPI
- [ ] T021 [P] \[US2\] Integration test(s): happy path
- [ ] T022 [P] \[US2\] Negative test(s): invalid input → correct 4xx + error `code`
...
- [ ] T027 [P] \[US3\] Contract test(s): endpoint request/response matches OpenAPI
- [ ] T028 [P] \[US3\] Integration test(s): happy path
- [ ] T029 [P] \[US3\] Negative test(s): invalid input → correct 4xx + error `code`
...
- Tests MUST exist for both happy-path and negative/error scenarios
...
Task: "Contract test for [endpoint]"
Task: "Integration test for [user journey]"
Task: "Negative test: invalid input → 4xx + error code"
```
